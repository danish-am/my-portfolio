...
const topPicksConfig = {
  recruiter: [
    ...
    { title: "Experience", imgSrc: "https://picsum.photos/seed/workexperience/250/200", icon: <FaBriefcase />, route: "/work-experience" }, // FIXED URL
  ...
  adventure: [
    { title: "Music & Sports", imgSrc: "https://picsum.photos/seed/music/250/200", route: "/music-and-sports", icon: <FaMusic /> },
